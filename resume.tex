  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Technologies}
          {Flutter, WebSocket, FCM}
        \resumeItem{Chat}
          {Implemented a realtime chat feature and AI chat assistant. Realtime-time chat using socket and support user send message with text, image, video and can react and reply message. Integrated FCM for push notification.}
        \resumeItem{Statistics and Data visualization}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Technologies}
          {React Native, NodeJS, TensorFlow.js}
    ...
    \resumeSubtitle
      ...
      \resumeItemListStart
        ...
        \resumeItem{Technologies}
          {React Native, Vue.js, NodeJS, Python, ReactJS, WinForms}
        \resumeItem{Responsibilities}
        ...
        \resumeItem{System}
          {Build a user store system, allowing other systems log in via Single Sign-On. Integrate systems: SSO Authentication, Face Authentication, Smart Library, Electronic Library, Streaming server.}
        \resumeItem{Frontend}
    ...
    \resumeSubtitle
      ...
      \resumeItemListStart
        \resumeItem{Technologies}
          {Flutter, PHP, ReactJS, Python, Kafka, WebSocket}
        \resumeItem{Responsibilities}
